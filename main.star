ethereum_package = import_module("github.com/celo-org/ethereum-package/main.star")
...
ethereum_package_static_files = import_module(
    "github.com/celo-org/ethereum-package/src/static_files/static_files.star"
)
...
def get_l1_config(all_l1_participants, l1_network_params, l1_network_id):
    ...
    env_vars["NETWORK_MNEMONIC"] = str(l1_network_params.preregistered_validator_keys_mnemonic)
    return env_vars
